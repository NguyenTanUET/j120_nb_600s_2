...
4. Records results in result/j120_no_bound_600s_2.csv with columns:
...
def main():
    ...
    output_file = result_dir / "j120_no_bound_600s_2.csv"

    # Create result directory if it doesn't exist
    os.makedirs(result_dir, exist_ok=True)

    # Define the range of files to process
    start_file = "j1206_8.data"  # File bắt đầu
    ...
    print(f"Using {600} seconds time limit per instance")
    ...
    local_path = "result/j120_no_bound_600s_2.csv"
