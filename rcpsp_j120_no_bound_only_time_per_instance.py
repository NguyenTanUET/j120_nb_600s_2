...
def main():
    ...
    output_file = result_dir / "j120_with_bound_600s_2.csv"
    ...
    local_path = "result/j120_with_bound_600s_2.csv"
    blob_name = f"results/{os.path.basename(local_path)}"  # ví dụ "results/j120_with_bound_600s_2.csv"
